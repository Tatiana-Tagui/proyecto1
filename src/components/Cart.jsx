      ...
      {carrito.length === 0 ? (
        <>
          <div className="espaciadoNav carritoVacio">
            <h1>Carrito Vacío</h1>
            <button className="btn btn-primary bg-light">
        ...
        <div className="cartList cartContainer espaciadoNav ">
          {carrito.map((prod, indice) => (
            <div
              className={`card cardCart border-light ${
                darkMode ? "cartItemDarkColor" : ""
              } `}
              key={indice}
          ...
          <div className="divButtons">
            ...
            <button
              className="botonesCarrito btn btn-danger"
              onClick={emptyCart}
            >
              Vaciar Carrito
            </button>
            <button
              className={`botonesCarrito btn ${
